        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400 max-w-sm leading-relaxed">
              Every utility tool you need in one lightning-fast, privacy-first
              platform. Built for developers, designers, and creators
              worldwide.
            </p>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
              ...
              <li>
                <Link
                  href="/categories/general-utility"
                  className="hover:text-brand-600 dark:hover:text-brand-400 transition-colors"
                >
                  General Utilities
                </Link>
              ...
              <li>
                <Link
                  href="/categories/security-crypto"
                  className="hover:text-brand-600 dark:hover:text-brand-400 transition-colors"
                >
                  Security & Crypto
                </Link>
          ...
          <div className="space-y-3">
            ...
            <div className="pt-2 flex items-center gap-3 text-slate-600 dark:text-slate-400">
              <a
                ...
                rel="noreferrer"
                aria-label="GitHub"
                className="p-2 rounded-xl bg-slate-200/60 dark:bg-slate-800 hover:text-brand-600 dark:hover:text-white transition-all"
              >
