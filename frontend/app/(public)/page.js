...
export default function LandingPage() {
  ...
  return (
    <div className="w-full overflow-x-hidden">
      <div className="w-full space-y-24 py-8 sm:py-16">
        {/* =========================================================
            HERO SECTION
        ========================================================= */}
        <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="w-full max-w-4xl mx-auto space-y-6">
            ...
            <motion.div
              ...
              className="inline-flex max-w-full items-center justify-center gap-2 px-3.5 py-1.5 rounded-full bg-brand-50 dark:bg-brand-950/80 text-brand-600 dark:text-brand-400 border border-brand-200 dark:border-brand-900 text-xs font-semibold shadow-sm"
            >
              <span className="w-2 h-2 shrink-0 rounded-full bg-brand-500 animate-pulse" />
            ...
            <h1 className="mx-auto max-w-4xl text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-[1.1]">
            ...
            >
              {/* Subtitle */}
              <p className="w-full max-w-2xl mx-auto text-base sm:text-xl text-slate-600 dark:text-slate-400 leading-relaxed">
                Format JSON, decode JWTs, generate secure
                passwords, and run conversions directly in your
                browser.
              </p>
              ...
              >
                ...
                {/* Popular Quick Pills */}
                <div className="flex w-full items-center justify-center flex-wrap gap-2 mt-4 text-xs">
            ...
            <div className="flex justify-center mt-10">
              ...
              >
                <Button
                  ...
                  icon={FiArrowRight}
                  iconPosition="right"
                  className="w-full sm:w-auto border-2 border-brand-500 dark:border-brand-400 px-7 py-3 rounded-2xl font-bold shadow-sm hover:bg-brand-50 dark:hover:bg-brand-950/40 hover:border-brand-600 dark:hover:border-brand-300 hover:shadow-md transition-all"
                >
                  View Complete Tool Catalog ({tools.length}{" "}
                  Tools)
                </Button>
              </Link>
            </div>
        ...
        ========================================================= */}
        <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl glass-card border border-slate-200/80 dark:border-slate-800 p-6 sm:p-12 shadow-glow">
            <SectionHeading
        ...
        <section className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative w-full rounded-3xl overflow-hidden p-6 sm:p-14 bg-gradient-to-r from-brand-600 via-indigo-600 to-accent-cyan text-white text-center shadow-2xl">
            <div className="relative z-10 w-full max-w-2xl mx-auto space-y-6">
              ...
              <p className="text-sm sm:text-base text-white/90 leading-relaxed">
                Start formatting, decoding, generating, and
                converting with zero friction today.
              </p>
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  ...
                  className="w-full sm:w-auto"
                >
                  <button className="w-full sm:w-auto px-8 py-3.5 rounded-2xl bg-white text-slate-900 font-bold hover:bg-slate-100 transition-colors shadow-lg active:scale-95 text-sm">
